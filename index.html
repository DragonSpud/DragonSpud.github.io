# Juan Eduardo Salas Heredia Portfolio
<!doctype html>
            ...
            <nav class="navbar navbar-default bootsnav navbar-fixed dark no-background">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">J.E.S.H</a>
                    </div><!--/.navbar-header-->
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="header-text">
                        <h2>hi <span>,</span> i am <br> Juan-Eduardo <br> Salas Heredia <span>.</span>   </h2>
                        <p>Game Designer/3D artist</p>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="single-about-txt">
                            <h3>
                                24 year old Communication Media and Game Technlogoy/Game Design student at Hanze University of Applied Science.
                            </h3>
                            <p>
                                With a passion for anything thats a machine or is mechanical in some way.
                            </p>
                            <!-- <div class="row">
                                <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="single-horizontal-timeline">
                            <div class="experience-time">
                                <h2>2021 - present</h2>
                                <h3>Bachelor <span>in </span> Communication Media and Games Technology</h3>
                                <!--</div><!--/.experience-time-->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="single-skill-content">
                            ...
                            <div class="barWrapper">
                                <span class="progressText">Blender</span>
                                <div class="single-progress-txt">
                                    <div class="progress ">
                            ...
                            <div class="barWrapper">
                                <span class="progressText">Unity</span>
                                <div class="single-progress-txt">
                                    <div class="progress ">
                            ...
                            <div class="barWrapper">
                                <span class="progressText">Cascadeur</span>
                                <div class="single-progress-txt">
                                    <div class="progress ">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="10" aria-valuemax="100" style="">
                ...
                <div class="portfolio-content">
                    <div class="isotope">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="item">
                                    <img src="assets/images/portfolio/240zWIP.png
                                         " alt="portfolio image" />
                        ...
                        <div class="single-contact-box">
                            <div class="contact-adress">
                                ...
                                <!--<div class="contact-add-info">
                                    ...
                                    <div class="single-contact-add-info text-center">
                                        <h3>email</h3>
                                        <p>salasherdia@gmail.com</p>
                                    </div>
                                    <!--<div class="single-contact-add-info">
                            ...
                            <div class="hm-foot-icon icon-center">
                                <ul>
    ...
    <footer id="footer-copyright" class="footer-copyright">
        <div class="container">
            <div class="hm-footer-copyright text-center">
                <p>
                    &copy; copyright Juan Eduardo Salas Heredia. design and developed by <a href="https://www.themesine.com/">themesine</a>
                </p><!--/p-->
            </div><!--/.text-center-->
        </div><!--/.container-->
